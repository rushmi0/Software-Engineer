...
เป็นหนึ่งในหลักการพัฒนาซอฟต์แวร์ที่มุ่งเน้นการพัฒนาโปรแกรมในช่วงเวลาที่สั้น ๆ โดยในแต่ละช่วงเวลา (รอบการทำงานหรือสเปริ้นต์ - Sprint) ทีมพัฒนาจะพัฒนาและส่งมอบฟีเจอร์หรือส่วนการทำงานที่เสร็จสมบูรณ์ไปยังลูกค้าหรือผู้ใช้

หลักการของการทำงานแบบ iterative ทำในลักษณะเป็นลูป (loop) และแต่ละรอบการทำงานจะสำรวจและแก้ไขความต้องการ หรือปัญหาในการพัฒนาก่อนที่จะมีการดำเนินการไปสู่ขั้นตอนถัดไป 
